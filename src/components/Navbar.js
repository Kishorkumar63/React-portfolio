        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto ms-5 mb-2 mb-lg-0  navbar">
            <li className="nav-item">
              ...
              <a style={{"color":'black'}} className="nav-link" href="#home">          <i className="fa-solid fa-house-user"></i>     Home</a>

            </li>
            <li className="nav-item">
              <a style={{"color":'black'}} className="nav-link" href="#about"><i
                className="fa-solid fa-user"></i>   About</a>



            </li>
            <li className="nav-item">
              <a style={{"color":'black'}} className="nav-link" href="#skills">  <i className="fa-solid fa-image"></i>    Skills</a>
            </li>
            <li className="nav-item">
              <a  style={{"color":'black'}} className="nav-link" href="#portfolio"><i
                className="fa-solid fa-address-card"></i>   Portfolio</a>
            </li>
            <li className="nav-item">
              <a  style={{"color":'black'}} className="nav-link" href="#portfolio"> <i
                className="fa-solid fa-phone"></i>   Contact Me</a>
            </li>
