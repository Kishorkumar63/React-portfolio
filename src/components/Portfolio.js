...
import Netflic from "./img/netflix.jpg"
...
<h1 className="text-center page-header" style={{"font-weight": "700"}}>Portfolio</h1>
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <img src={portfolio} className="d-block w-100" alt="..."/>
    ...
    <div className="carousel-item">
      <img src={Netflic} className="d-block w-100" alt="..."/>
      <div className="carousel-caption d-none d-md-block">
    ...
    <div className="carousel-item">
      <img src={Qr} className="d-block w-100" alt="..."/>
      <div className="carousel-caption d-none d-md-block">
